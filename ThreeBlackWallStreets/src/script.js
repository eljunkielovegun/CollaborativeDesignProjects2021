...
testImage.src = '/stories/richmond/'+richmondStoriesArray[5][0]+'/1.jpg'
testImage.height = 250
imageDiv.appendChild(testImage)

//setting the text
storyGraphOne.innerHTML = richmondStoriesTextArray[5][0]

let firstStoryImage = document.createElement('img')
firstStoryImage.src = '/stories/richmond/'+richmondStoriesArray[5][0]+'/1.jpg'
...
arrowDown.onclick = () => {
    storyInnerIndex++
    storyInnerIndex = storyInnerIndex%richmondStoriesArray[5][1]
   storyGraphOne.innerHTML = richmondStoriesTextArray[5][storyInnerIndex]
   firstStoryImage.src = '/stories/richmond/'+richmondStoriesArray[5][0]+'/' + (storyInnerIndex+1) +'.jpg'
  // console.log(i)
}
arrowUp.onclick = () => {
    storyInnerIndex--
      ...
      storyInnerIndex = Math.abs(-storyInnerIndex%richmondStoriesArray[5][1])
   storyGraphOne.innerHTML = richmondStoriesTextArray[5][storyInnerIndex]
   firstStoryImage.src = '/stories/richmond/'+richmondStoriesArray[5][0]+'/' + (storyInnerIndex+1) +'.jpg'
...
//load story test with maggie walker

console.log(richmondStoriesTextArray[5])
 ...
 */
 ...
 for(let i = 0; i < richmondStoriesArray.length; i++){
     ...
     richmondOrbMeshes[i].castShadow = true
 }
